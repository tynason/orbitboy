...
class Mandel(object):
	...
	def plotme(self):
		...
		while contin==True:
			...
			ax1.plot(xdata[0:end1],ydata[0:end1],lw=linewid,color=myyell)
			...
			#ax5.plot(raddata,lw=linewid,color=myyell)
			...
			if dodata:
				...
				ax5.plot(raddata[0:kappa-trimend],lw=linewid,color=mybritegrn)
				ax7.plot(angdata,lw=linewid,color=mygreen)
...
wid=1000;ht=700;xpos=10;ypos=10
wid=1200;ht=650;xpos=10;ypos=10
